#!/usr/bin/env python3
"""
Occupational AI Capability Rating Pipeline — Skills & Abilities Enhanced
=========================================================================
Identical to run_ratings.py but uses the enriched occupation JSON that includes
the top 10 O*NET skills and abilities (with importance scores out of 100) for
each occupation.  The LLM prompt is modified so that these skills/abilities
and their importance scores inform the capability ratings.
...
Usage:
    python run_ratings_skills_abilities.py
"""
...
# Configuration
# ---------------------------------------------------------------------------
INPUT_JSON_FILE = "occupation_data_skills_abilities_ranked.json"
...
def main():
    ...
    print("  — Skills & Abilities Enhanced —")
    print("=" * 65)
